...
Once the `conda-forge` channel has been enabled, `fps-retrolab` can be installed with:

```
conda install fps-retrolab
```

It is possible to list all of the versions of `fps-retrolab` available on your platform with:
